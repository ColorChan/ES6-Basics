...
// 天干/地支表(["甲","乙","丙","丁","戊","己","庚","辛","壬","癸"]/["子","丑","寅","卯","辰","巳","午","未","申","酉","戌","亥"])
...
// 日期转农历称呼表
const nStr2 = ['\u521d', '\u5341', '\u5eff', '\u5345']
// 月份转农历称呼表(['正','一','二','三','四','五','六','七','八','九','十','冬','腊'])
...
// 传入农历年月日以及传入的月份是否闰月获得详细的公历、农历object信息 <=>JSON （如果是农历闰月第四个参数赋值true即可）
